    ...
    const data1 = paginateData.map((values) => {
        ...
        return `
            <tr >
                ...
                <td><img class="imageview" src="http://localhost:3000/employees/${Id}/avatar" alt="" height="30px" width="30px">${values.salutation}.${values.firstName}.${values.lastName}</td>
                <td>${values.email}</td>
                <td>${values.phone}</td>
                <td>${values.gender}</td>
                <td>${values.dob}</td>
                ...
                <td>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="http://127.0.0.1:5500/index2.html?id=${Id}"><i class="fa-regular fa-eye"></i>View details</a></li>
                            <li><a class="dropdown-item" href="#" onclick="editid('${values.id}')"><i class="fa-solid fa-pencil"></i>Edit</a></li>
                            <li><a class="dropdown-item" href="#" onclick="dele('${Id}')"><i class="fa-solid fa-trash"></i>Delete</a></li>
                        </ul>
                    </div>
                </td>
            </tr>`;
...
function dele(Id) {
    ...
    del.addEventListener('click', function confirmDelete() {
...
function editid(id) {
    ...
    //     e.preventDefault();
     ...
     function editvalue() {
        ...
        editData.append("avatar", editPreviewimage.files[0]);

         fetch(`http://localhost:3000/employees/${newId}/avatar`, {
            method: "POST",
            body: editData,
        })
...
document.getElementById("editPreviewimage").addEventListener('change', function (event) {
    ...
    // const container = document.getElementById("edit_imagecontainer");
